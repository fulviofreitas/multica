...
/** Post-redemption echo: the Discord user id the token carried is now bound
 * to the logged-in Multica user in this workspace/installation. Mirrors
 * RedeemTelegramBindingTokenResponse. */
export interface RedeemDiscordBindingTokenResponse {
  workspace_id: string;
