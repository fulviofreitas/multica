...
| Discord | `MULTICA_DISCORD_SECRET_KEY` | base64로 인코딩한 32바이트 Bot token 암호화 키. 없으면 연동이 활성화되지 않음 |
...
설정 단계는 [GitHub 연동](/github-integration#자체-호스팅-설정), [Feishu Bot](/lark-bot-integration#자체-호스팅-설정), [Slack Bot](/slack-bot-integration#자체-호스팅-설정), [Telegram Bot](/telegram-bot-integration#관리-및-자체-호스팅), [Discord Bot](/discord-bot-integration#자체-호스팅-설정)을 참고하세요.
