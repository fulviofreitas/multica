...
| Discord | `MULTICA_DISCORD_SECRET_KEY` | base64 编码的 32 字节 Bot token 加密密钥；未配置时该集成不启用 |
...
配置步骤见 [GitHub 集成](/github-integration#自托管配置)、[飞书 Bot](/lark-bot-integration#自托管配置)、[Slack Bot](/slack-bot-integration#自托管配置)、[Telegram Bot](/telegram-bot-integration#自托管配置)和 [Discord Bot](/discord-bot-integration#自托管配置)。
