...
| Discord | `MULTICA_DISCORD_SECRET_KEY` | Base64-encoded 32-byte bot token encryption key; the integration stays off without it |
...
For setup steps, see [GitHub integration](/github-integration#self-hosting-setup), [Lark bot](/lark-bot-integration#self-hosting-setup), [Slack bot](/slack-bot-integration#self-hosting-setup), [Telegram bot](/telegram-bot-integration#self-hosting-setup), and [Discord bot](/discord-bot-integration#self-hosting-setup).
